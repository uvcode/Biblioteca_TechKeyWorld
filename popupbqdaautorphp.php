...
function datos(codigoaut){
    opener.document.formingresarlibro.codigoautor.value = codigoaut;
...
?>
                    ...
                    <body class="">
                        ...
                        <div class="caja total"><p class="titulo_g">BUSQUEDA DE AUTOR POR NOMBRE</p>
                        </div>
...
<table   border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#AEE4FF">
            ...
            <td  width="37">Codigo Autor</td>
        <td  width="66">Nombre Autor</td>
        <td width="240">Apellidos Autor</td>
        <td width="208">NacionalidadAutor</td>
  ...
  //if($_GET['q']<>""){
   ...
   //$bsqnombre=$_POST["nombrealumno"];
    ...
    $i=0;
        ...
        $query = "SELECT * FROM tautor where NombreAutor like '%$bsqnombre%'";
        ...
        while ($row = mysql_fetch_array($r_query)) {
            ...
            $codigoaut=str_replace(" ", "&nbsp;", $codigoaut);

            $nombreaut=$row{'NombreAutor'};
            $nombreaut=str_replace(" ", "&nbsp;", $nombreaut);

            $apellidosaut=$row{'ApellidosAutor'};
            $apellidosaut=str_replace(" ", "&nbsp;", $apellidosaut);

            $nacionalidadaut=$row{'NacionalidadAutor'};
            $nacionalidadaut=str_replace(" ", "&nbsp;", $nacionalidadaut);
            ...
            echo "
            <tr OnMouseOver='Resaltar_On(this);' OnMouseOut='Resaltar_Off(this);
            ' OnClick=datos('$codigoaut')>
                <td>$i</td>
                <td>$codigoaut</td>
                <td>$nombreaut</td>
                <td>$apellidosaut</td>  
                <td>$nacionalidadaut</td>      
