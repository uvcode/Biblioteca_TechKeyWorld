...
<table   border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#AEE4FF">
        ...
        <td width="240">Categoria</td>
        <td width="208">Nombre Autor</td>
        <td width="208">Nombre Libro</td>
        <td width="208">Edicion</td>
        <td  width="37">Estado</td>
  ...
  //if($_GET['q']<>""){
   ...
   //$bsqnombre=$_POST["nombrealumno"];
    ...
    $i=0;
        ...
        $query = "SELECT * FROM tlibro where nombrelibro like '%$bsqnombre%'";
        ...
        while ($row = mysql_fetch_array($r_query)) {
            ...
            $codigolib=str_replace(" ", "&nbsp;", $codigolib);
